...
cc:
	...
	cmake -H./opencv -B$(BUILD_DIR) -DCMAKE_TOOLCHAIN_FILE=$(PWD)/$(CMAKE_FILE) \
		 ...
		 -DBUILD_opencv_optflow=FALSE \
		 -DBUILD_opencv_bgsegm=FALSE \
		 -DBUILD_opencv_bioinspired=FALSE \
		 -DBUILD_opencv_tracking=FALSE \
		 -DBUILD_opencv_java=FALSE \
		 -DBUILD_opencv_ml=FALSE \
		 -DBUILD_opencv_objdetect=FALSE \
		 -DBUILD_opencv_xobjdetect=FALSE \
